...
export const PRIMARY = colors.BLUE_1;
export const SECONDARY = colors.RED_1;

export const PRIMARY_BACKGROUND = colors.WHITE_2;
export const SECONDARY_BACKGROUND = colors.WHITE_1;
...
export const UNFAVOURITE_COLOR = colors.WHITE_1;
